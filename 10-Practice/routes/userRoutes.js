...
router.route('/').get(authenticateUser,authorisePermissions('admin','owner'), getAllUsers); // We need to authenticate the user in the first order then we check if the user is admin
